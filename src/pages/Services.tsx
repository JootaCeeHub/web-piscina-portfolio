...
const Services: React.FC = () => {
  ...
  const portfolioProjects = [
    {
      id: 1,
      title: 'Villa Premium Residencial',
    ...
    {
      id: 2,
      title: 'Casa de Campo Santiago, Chile',
      category: 'residencial',
      location: 'Santiago, Chile',
    ...
    {
      id: 3,
      title: 'Residencia Zona central de Chile',
      category: 'residencial',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-br from-blue-900 to-blue-800 rounded-2xl shadow-lg p-8 lg:p-12 text-center text-white mt-20">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <button
              onClick={() => window.open('https://wa.me/56900000000?text=Hola, me interesa una piscina premium de fibra de vidrio. ¿Podrían enviarme el catálogo completo?', '_blank')}
